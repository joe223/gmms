...
L.TileLayer.WMTS = L.TileLayer.extend({
    ...
    getTileUrl: function (tilePoint, zoom) { // (Point, Number) -> String
        ...
        console.log('http://t' + (Math.floor(Math.random() * 8) + 0) + '.tianditu.com/DataServer?T=cva_c&L=' + ident + '&Y=' + tilerow + '&X=' + tilecol);
        return url = 'http://t' + (Math.floor(Math.random() * 8) + 0) + '.tianditu.com/DataServer?T=cva_c&l=' + ident + '&y=' + tilerow + '&x=' + tilecol;
    },
